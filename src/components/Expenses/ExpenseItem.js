...
export default function ExpenseItem(props) {
  console.log(props.deleteExp + " oka")
  ...
  return (
    ...
    <div className='expense-item__description'>
      ...
      <div>
        <Button variant="outlined" size="lg" style = {{color : "white",borderRadius: 15 }} onClick={(e) => props.deleteExp(e,props.title,props.date)}><strong>Delete</strong></Button>
      </div>
    </div>
  </Card>
  );
